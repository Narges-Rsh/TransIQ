...
#A Transformer based model  with a Complex CNN layer in Tokenization module

class TransIQ_Complex(ModelBase):
    ...
    def __init__(
        ...
        dropout_rate=0.1,
        seq_length=128,       
        token_multi = 32,   # number of tokens= seq_length/token_multi           
        d_model=512,   #token_size (token_multi) * 2* number of CNN output hannels
        **kwargs):
        ...
        self.cconv=nn.Conv1d(input_channels, 8, 7, padding=3, dtype=torch.cfloat, bias=False)
